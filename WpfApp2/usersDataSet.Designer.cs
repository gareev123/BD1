...
namespace WpfApp2 {
    ...
    public partial class usersDataSet : global::System.Data.DataSet {
        ...
        public partial class usersDataTable : global::System.Data.TypedTableBase<usersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public usersRow AddusersRow(int id, string login, string password, string FIO, string status) {
...
namespace WpfApp2.usersDataSetTableAdapters {
    ...
    public partial class usersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[users] WHERE (([id] = @Original_id) AND ([login] = @Original_login) AND ([password] = @Original_password) AND ((@IsNull_FIO = 1 AND [FIO] IS NULL) OR ([FIO] = @Original_FIO)) AND ((@IsNull_status = 1 AND [status] IS NULL) OR ([status] = @Original_status)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[users] ([id], [login], [password], [FIO], [status]) VALUES (@i" +
                "d, @login, @password, @FIO, @status);\r\nSELECT id, login, password, FIO, status F" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[users] SET [id] = @id, [login] = @login, [password] = @password, [FIO] = @FIO, [status] = @status WHERE (([id] = @Original_id) AND ([login] = @Original_login) AND ([password] = @Original_password) AND ((@IsNull_FIO = 1 AND [FIO] IS NULL) OR ([FIO] = @Original_FIO)) AND ((@IsNull_status = 1 AND [status] IS NULL) OR ([status] = @Original_status)));
SELECT id, login, password, FIO, status FROM users WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WpfApp2.Properties.Settings.Default.usersConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, login, password, FIO, status FROM dbo.users";
        ...
        public virtual int Delete(int Original_id, string Original_login, string Original_password, string Original_FIO, string Original_status) {
        ...
        public virtual int Insert(int id, string login, string password, string FIO, string status) {
        ...
        public virtual int Update(int id, string login, string password, string FIO, string status, int Original_id, string Original_login, string Original_password, string Original_FIO, string Original_status) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string login, string password, string FIO, string status, int Original_id, string Original_login, string Original_password, string Original_FIO, string Original_status) {
            return this.Update(Original_id, login, password, FIO, status, Original_id, Original_login, Original_password, Original_FIO, Original_status);
        }
    }
